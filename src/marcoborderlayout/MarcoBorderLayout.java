 ...
 * @author maryse
 * 
 * El administrador de esquemas BorderLayout (el predeterminado para un objeto JFrame)
 * ordena los componentes en cinco regiones: NORTH, SOUTH, EAST, WEST y CENTER. NORTH 
